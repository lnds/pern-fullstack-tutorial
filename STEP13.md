# Test unitarios para nuestros nuevos servicios

Nuestros nuevos servicios pueden evolucionar con el tiempo, así que es recomendable que tengamos tests unitarios específicos.

Vamos a construirlos ahora

## Tests unitarios para crypt

En la carpeta `services/__tests__` dejaremos el archivo `crypt.test.js`:
